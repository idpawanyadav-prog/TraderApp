...
def compute_pair(sector, sym1, sym2, series1, series2, params):
    ...
    try:
        ...
        # NOTE: no minimum-correlation cutoff here — the scan returns every
        # pair; the UI screener filters by correlation/density client-side.
        ...
        # Excel STDEV.P()
        s = float(np.std(ratio, ddof=0))

        res.density = normal_cdf(cur, m, s)
